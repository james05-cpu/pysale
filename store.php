...
switch($_GET["action"]) {
	case "add":
		if(!empty($_POST["quantity"])) {
			...
			$itemArray = array($productByCode["productname"]=>array('name'=>$productByCode["productname"], 'code'=>$productByCode["productname"], 'quantity'=>$_POST["quantity"], 'price'=>$productByCode["price"], 'image'=>$productByCode["imgsrc"]));	
			}
...
<a href="buy.php" class="purchase-btn" id="p-btn">Buy Now</a>
<div class="prducts_row">
	...
	?>
		...
		<div class="product-item">
			...
			<div class="product-image"><img src="<?php echo $product_array["imgsrc"]; ?>" style="width: 250px; height: 155px;"></div>
			<div class="product-tile-footer">
			<div class="product-title"><?php echo $product_array["productname"]; ?></div>
			<div class="product-price"><?php echo "KSH ".$product_array["price"]; ?></div>
