...
$res=$conn->query("SELECT* FROM USERINFO where username='$sid'");
while( $row=$res->fetchArray()){
?>
 <div class="profile-card">
           <img src="<?php echo $row['imgsrc'];?>" style="width:100%; height:250px">
...
<input type="hidden" value="<?php echo $row['username'];?>" class="username" name="username" >
 <p><button type="button" class="viewbtn" id="follow">Follow User</button></p>

               <p><button type="button" class="viewbtn" id="skip">Skip</button></p>
...
<script type="text/javascript">
    document.getElementById("skip").addEventListener('click', sub);
    function sub() {
window.location="store.php";
        }
       
    document.getElementById("follow").addEventListener('click', follo);
    function follo() {
