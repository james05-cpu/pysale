...
$followers=array();
$followers=array($_SESSION['username']);
...
<div class="container1">
    <div class="image">
  <img src="<?php echo $row['follower_image'];?>" alt="">
  </div>
<input type="hidden" class="fid" name="fid" value="<?php echo $row['follower_id'];?>">
  <p><?php echo $row['follower_name'];?></p>
  <br>
  <span class="unfollow" style="cursor: pointer;">Unfollow</span>
<span class="view" style="cursor: pointer;">Shop Now</span>
</div>

<?php
}
if($c==0){
echo("<div class='notice'><h3 style='display:block;'>People following you appear here</h3><h4>Suggested traffic!</h4></div>");
}
else{
    echo("<h4>Suggested traffic!</h4>");
}
?>
<?php

$stm=$conn->prepare("SELECT* FROM USERINFO");
$res=$stm->execute();
while( $row=$res->fetchArray()){
    if(!in_array($row['username'], $followers)){

?>
<div class="container1">
    <div class="image">
  <img src="<?php echo $row['imgsrc'];?>" alt="Avatar" style="width:100%;">
  </div>
<input type="hidden" class="fid" name="fid" value="<?php echo $row['username'];?>">
        ...
        <div class="titlef">
            ...
            <div class="colfb">
                    ...
                    <div class="colfd">
                        ...
                        <form action="text-followers.php" method="post">
